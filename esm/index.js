...
import Signal, { batch, computed, effect, isKensingtonSignal, signal } from './lib/reactive/signal.js';
...
// the reactive primitives (signal/effect/computed/batch). Combined with `"sideEffects": false`
// in package.json, an unused `t` removes the class and all its transitive imports.
export const t = /* @__PURE__ */ new Kensington();

export { batch, computed, effect, isKensingtonSignal, signal };
