...
- The nested-attribute and style-attribute object checks in the serialisers now use `typeof val === 'object'` rather than `val?.constructor === Object`, which also handles null-prototype objects correctly.
