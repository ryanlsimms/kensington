...
- `toElement()` now assigns the correct namespace URI to `xlink:*`, `xml:*`, and `xmlns*` attributes.
...
- SVG attribute maps and types now remain complete, preserve element-specific validators, and isolate mutable validator arrays between public maps.
