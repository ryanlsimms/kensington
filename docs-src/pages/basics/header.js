...
export function basicsHeader(t) {
  return t.header([
    headerGithubLink(t),
    t.h1('Kensington'),
    t.div({ class: 'badges' }, [
      t.a({ href: 'https://www.npmjs.com/package/kensington' }, t.img({ src: 'https://img.shields.io/npm/v/kensington', alt: 'npm' })),
      t.a({ href: 'https://github.com/ryanlsimms/kensington/actions/workflows/ci.yml' }, t.img({ src: 'https://github.com/ryanlsimms/kensington/actions/workflows/ci.yml/badge.svg', alt: 'CI' })),
      t.a({ href: 'https://opensource.org/licenses/ISC' }, t.img({ src: 'https://img.shields.io/badge/License-ISC-blue.svg', alt: 'License: ISC' })),
    ]),
    t.p('HTML/SVG/MathML template library for JavaScript and TypeScript. Tags, attribute names/values, inline style property names, and some nested tags are comprehensively typed against the official specs. Components are plain functions with no JSX, no compiler, and very little to learn.'),
    ...
    code(t, 'bash', 'npm install kensington'),
    ideMock(t, {
      filename: 'index.ts',
      lines: [
