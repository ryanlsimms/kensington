...
export function architectureOverview(t) {
  return [
    t.header([
      headerGithubLink(t),
      t.h1('Architecture'),
    ...
    t.section({ id: 'introduction' }, [
      ...
      t.ul({ class: 'feature-list' }, [
        ...
        t.li('Curious how a small library supports signals, SSR, hydration, and reconciliation in roughly 1 200 lines of hand-written source'),
      ]),
      t.p([
      ...
      t.table([
        ...
        t.tbody([
          t.tr([
            ...
            t.td(loc(t, 'esm/tag-classes/content-tag.js')),
          ]),
          t.tr([
            t.td(term(t, 'Signal')),
            t.td([
            ...
            t.td(loc(t, 'esm/lib/reactive/signal.js')),
          ]),
          t.tr([
            t.td(term(t, 'effect')),
            t.td([
          ...
          t.tr([
            t.td(term(t, 'Lifecycle')),
            t.td('Per-element orchestrator that owns every signal effect, the persist mechanism, and the connect/disconnect callback chain.'),
            t.td(loc(t, 'esm/lib/reactive/lifecycle.js')),
          ]),
          t.tr([
            t.td(term(t, 'DOM tracker')),
            t.td([
              'A shared ',
              t.code('MutationObserver'),
              ' that fires stop chains on removal and connect callbacks on insertion. One per document.',
            ]),
            t.td(loc(t, 'esm/lib/reactive/dom-tracker.js')),
          ]),
          t.tr([
            t.td(term(t, 'Reconciler')),
            t.td([
            ...
            t.td(loc(t, 'esm/lib/reactive/reconcile.js')),
          ]),
          t.tr([
            t.td(term(t, 'persist mode')),
            t.td([
              'Opt-in via the ',
              t.code('persist'),
