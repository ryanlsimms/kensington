...
cls.set('active');         // DOM updates immediately`),
    ...
    t.aside([
      t.p([
        ...
        ' are permanently destructive, with no state left to resume from. An effect can pause and resume because its callback re-runs from scratch each time. ',
        t.code('effect.stop()'),
        ' is the permanent equivalent, matching ',
        t.code('signal'),
        ' and ',
        t.code('computed'),
        ' ',
