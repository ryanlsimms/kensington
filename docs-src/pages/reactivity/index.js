...
export function reactivitySidebar() {
  return [
    ...
    t.ul([
      ...
      t.li([
        t.a({ href: '#signals-batching' }, 'Update timing'),
        t.ul([
          t.li(t.a({ href: '#automatic-batching' }, 'Automatic batching')),
          t.li(t.a({ href: '#apply-pending-reactive-updates' }, 'Apply pending updates')),
          t.li(t.a({ href: '#choosing-update-timing' }, 'Choose how to wait')),
          t.li(t.a({ href: '#reactive-focus-example' }, 'Focus an input')),
          t.li(t.a({ href: '#defer-a-callback' }, 'Run a callback later')),
          t.li(t.a({ href: '#wait-for-removal-cleanup' }, 'Wait for removal cleanup')),
          t.li(t.a({ href: '#reactive-animation-reset' }, 'Reset an animation')),
        ]),
      ]),
